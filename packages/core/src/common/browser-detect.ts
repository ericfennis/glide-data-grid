...
export const browserIsSafari = lazy(() => window.navigator.userAgent.indexOf("Mac OS") > -1 && window.navigator.userAgent.indexOf("Safari") > -1 && window.navigator.userAgent.indexOf("Chrome") < 0);
